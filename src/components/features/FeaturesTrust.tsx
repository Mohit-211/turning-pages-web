  ...
  const trustItems = [
    {
      ...
      description: "Enterprise-grade encryption protects your login credentials and personal data",
    },
    {
      icon: Eye,
      title: "Private Manuscripts",
      description: "Your work is never shared, sold, or used for AI training without consent",
    },
    {
      icon: UserCheck,
      title: "Human-Reviewed Editing",
      description: "Professional editors sign NDAs and follow strict confidentiality protocols",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We take the security of your creative work seriously. Your manuscripts 
            and personal information are protected at every step.
          </p>
        </motion.div>
