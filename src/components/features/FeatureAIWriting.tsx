        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Our AI writing assistant helps you generate initial drafts by simply 
              describing your ideas. Expand scenes, rewrite passages for different 
              tones, and overcome writer's block with conversational AI support 
              that understands your creative vision.
            </p>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 bg-muted rounded-2xl rounded-tl-sm p-4">
                    <p className="text-sm text-foreground">
                      Write a tense opening scene where the detective arrives at an 
                      abandoned warehouse at midnight...
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 bg-secondary/10 rounded-2xl rounded-tl-sm p-4 border-l-4 border-secondary">
                    <p className="text-sm text-foreground leading-relaxed">
                      The rusted gates groaned as Detective Morgan pushed through, 
                      her flashlight cutting weak arcs through the fog. The warehouse 
                      loomed ahead—a skeletal shadow against the moonless sky. 
                      Something moved in the darkness beyond the broken windows...
                    </p>
                  </div>
                </div>
              </div>
