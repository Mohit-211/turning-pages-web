        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-6">
              ...
              <span className="text-sm font-semibold">Summaries & Synopses</span>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { icon: BookOpen, title: "Chapter Summaries", desc: "Quick recap of each chapter" },
                { icon: ScrollText, title: "Book Synopsis", desc: "Complete story overview" },
                { icon: Sparkles, title: "Marketing Copy", desc: "Blurbs and taglines" },
                { icon: FileText, title: "Query Letters", desc: "Agent-ready pitches" },
              ].map((item, index) => (
                <motion.div
                  key={item.title}
          ...
          >
            <div className="bg-card rounded-2xl shadow-card p-8 border border-border">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-semibold text-foreground">Generated Synopsis</span>
              </div>
              <div className="prose prose-sm">
                <p className="text-muted-foreground leading-relaxed italic">
                  ...
                  believed about her city's founding families. Racing against time 
                  as the killer resurfaces, she must piece together the truth before 
                  becoming the next victim in a deadly game of secrets and lies..."
                </p>
              </div>
