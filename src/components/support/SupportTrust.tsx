  ...
  const trustPoints = [
    {
      ...
      description: "Your manuscripts and personal data are protected with enterprise-grade encryption at rest and in transit.",
    },
    {
      icon: Eye,
      title: "Your Work Stays Yours",
      description: "We never share, sell, or use your creative content for AI training without your explicit consent.",
    },
    {
      icon: FileCheck,
      title: "Confidential Editing",
      description: "All editors sign strict NDAs and follow professional confidentiality protocols.",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
            Your Stories Are <span className="text-gradient-brand">Safe With Us</span>
          </h2>
        ...
        >
          ...
          <a href="#" className="text-secondary hover:underline ml-1">Privacy Policy</a> and 
